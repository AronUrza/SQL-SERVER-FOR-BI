...
CREATE SCHEMA AU -- Un esquema es una forma de agrupar las tablas 

CREATE TABLE AU.TP_CLIENTE
( COD INT
)
...
-- TABLA FINAL QUE USARA EL DATA SCIEN PARA REALIZAR SUS CAMPAÑAS

SELECT *
FROM BDS.FACT_CAMPAÑAS 

-- FINALMENTE ELIMINAMOS LAS TABLAS TEMPORALES 
